...
function TableUser() {
    ...
    const classWhenDisplayAsideBar =
        'fixed bottom-[--mrForChild] left-0 ml-[98px] w-[calc(100vw-118px)] transition-all duration-[2s] bg-[white] px-[26px] rounded-b-[--borderForLayout] xs_max:px-0 xs_max:w-[calc(100%-8px)] xs_max:ml-[--heightNav] xs_max:bottom-[--margin4px]';
    const classWhenHiddenAsideBar =
        'fixed bottom-[--mrForChild] left-0 ml-[20px] w-[calc(100vw-40px)] transition-all duration-[2s] bg-[white] px-[26px]  rounded-b-[--borderForLayout] xs_max:px-0 xs_max:w-[calc(100vw-8px)] xs_max:ml-[--margin4px] xs_max:bottom-[--margin4px]';
