...
import bgAvatar from './icon/icon_layout/bgAvatar.svg';
import notification from './icon/icon_layout/notification.svg';
import iconLogout from './icon/icon_layout/iconLogout.svg';
